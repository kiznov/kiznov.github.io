 ...
 * @author DevilBro & translate by kizn
 ...
 * @updateUrl https://kiznov.github.io/ShowHiddenChannels.plugin.js
 */
		...
		return class ShowHiddenChannels extends Plugin {
			...
			openAccessModal (channel, allowed) {
				...
				BDFDB.ModalUtils.open(this, {
					size: "MEDIUM",
					// header: BDFDB.LanguageUtils.LanguageStrings.CHANNEL + " " + BDFDB.LanguageUtils.LanguageStrings.ACCESSIBILITY, ##fix
					header: BDFDB.LanguageUtils.LanguageStrings.ACCESSIBILITY,
					...
					children: [
						BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.ModalComponents.ModalTabContent, {
							...
							// tab: BDFDB.LanguageUtils.LanguageStrings.OVERLAY_SETTINGS_GENERAL_TAB, ##fix
							tab: "Информация",
							children: [{
						...
						BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.ModalComponents.ModalTabContent, {
							// tab: this.labels.modal_allowed, ##fix
							tab: "Разрешено",
						...
						BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.ModalComponents.ModalTabContent, {
							// tab: this.labels.modal_denied, ##fix
							tab: "Запрещено",
